...
class LondonApi implements CityApi {
     ...
     */
    private getNaptan(arrival: TflApiResponseItem, arrivals: TflApiResponse): string {
     ...
     */
    private resolveEustonNaptan(arrival: TflApiResponseItem): "940GZZLUEUS_CC" | "940GZZLUEUS_B" {
     ...
     */
    private resolveEdgwareRoadNaptan(arrival: TflApiResponseItem, arrivals: TflApiResponse): "940GZZLUERC_D" | "940GZZLUERC_HC" {
        const vehicleId = arrival.vehicleId;
